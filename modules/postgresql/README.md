# Terraform module for Azure Database for PostgreSQL server
...
| geo_redundant_backup_enabled | Whether to enable geo-redundant server backup (Basic SKU will not work while this is `true`) | bool | true | no |
